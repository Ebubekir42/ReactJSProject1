        ...
        <section className="section signInPage">
            ...
            <div className="container">
                <div className="box card p-3 shadow border-0">
                    ...
                    <form className="mt-3">
                        <h2 className="mb-4">GİRİŞ YAP</h2>
                        ...
                        <a className="border-effect cursor txt">Parola Unuttunuz Mu?</a>

                        <div className="d-flex align-items-center mt-3 mb-3">
                            <Button className="btn-blue btn-lg btn-big col">Giriş Yap</Button>
                        ...
                        <p className="txt">Kayıtlı değil misiniz? <Link to="/signUp" className="border-effect">Kayıt Ol</Link></p>
